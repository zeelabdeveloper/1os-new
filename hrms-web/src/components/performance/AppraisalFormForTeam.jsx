...
const AppraisalFormForTeam = ({ visible, onClose, editData }) => {
  ...
  const departmentsQuery = useQuery({
    ...
    queryFn: () => fetchDepartmentsByHeadId(user?._id),
    enabled: visible,
  });
...
export default AppraisalFormForTeam;
